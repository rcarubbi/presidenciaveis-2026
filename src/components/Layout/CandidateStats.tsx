  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-6">
      <div className="text-center">
        <p className="text-xl md:text-2xl font-bold" style={{ color }}><DataLink data={c.age} /></p>
        <p className="text-xs text-gray-500">anos</p>
      </div>
      <div className="text-center">
        <p className="text-xl md:text-2xl font-bold" style={{ color }}><DataLink data={c.careerYears} /></p>
